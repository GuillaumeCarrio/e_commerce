 ...
 */
final class Version20240119110834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE email email VARCHAR(180) DEFAULT NULL');
        $this->addSql('ALTER TABLE user CHANGE email email VARCHAR(180) DEFAULT NULL');
        $this->addSql('ALTER TABLE vendeur CHANGE email email VARCHAR(180) DEFAULT NULL');
    }
